...
<?			
			...
			$price = number_format($row['price38']);
			$price1 = number_format(round($row['price38']*(100-$row['discount38'])/100,-2));			
?>
			<!-- form2 시작  -->
						...
						<table border="0" cellpadding="0" cellspacing="0" width="370" class="cmfont">
							...
							<tr>
								...
								<td style="padding-left:10px">
									<font color="282828"><?=$row['name38']?></font><br>
									<?
									if ($row["icon_new38"]==1){
									...
									if ($row["discount38"]>0){
										echo("<font color='red'>$row[discount38]%</font>");
									}
									?>
								</td>
							</tr>
							...
							<tr>
								...
								<td width="1" bgcolor="E8E7EA"></td>
								<td style="padding-left:10px"><font color="0288DD"><b><?=$price1?>원</b></font></td>
							</tr>
							<tr><td colspan="3" bgcolor="E8E7EA"></td></tr>
							<!-- 옵션 -->
							<tr>
								...
								<td style="padding-left:10px">
									...
									<?	
									$query1 = "select * from opts where opt_no38=$row[opt1]";
									...
									for($i=0;$i<$count1;$i++){
										...
										if ($row['opt1']==$row1['opt_no38'])
											echo("<option value='$row1[no38]'>$row1[name38]</option>");
										else
											echo("<option value='$row1[no38]'>$row1[name38]</option>");
									}
									?>
									...
									<option value="">선택하세요</option>
									<?	
									$query2 = "select * from opts where opt_no38=$row[opt2]";
									...
									for($i=0;$i<$count2;$i++){
										...
										if ($row1['opt2']==$row2['opt_no38'])
											echo("<option value='$row2[no38]'>$row2[name38]</option>");
										else
											echo("<option value='$row2[no38]'>$row2[name38]</option>");
									}
									?>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="746" style="font-size:9pt">
				...
				<tr>
					<td height="200" valign=top style="line-height:14pt">
						...
						<br>
						<center>
						<img src="product/<?=$row['image1']?>"width="746"><br><br><br>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="746">
				<tr>
					<td align="center" class="cmfont"><?=$row['content38']?></td>
				</tr>
			</table>
			<table border="0" cellpadding="0" cellspacing="0" width="746" class="cmfont">
				<tr><td height="10"></td></tr>
